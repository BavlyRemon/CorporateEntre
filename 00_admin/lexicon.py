...
IPM_TERMS: dict[str, list] = {
    ...
    "Horizon Scanning / Sense-making": [
        ...
        {"base": "transform", "aliases": ["transforms", "transformed", "transforming", "transformation", "transformations", "transformative", "transformational"]},
        {"base": "shift", "aliases": ["shifts", "shifting", "shifted"]},
        {"base": "inflection"},
        {"base": "anticipate", "aliases": ["anticipates", "anticipated", "anticipating", "anticipation"]},
        # Added 2026-05-16 (user request): exploratory-sensing vocabulary.
        {"base": "wander", "aliases": ["wanders", "wandered", "wandering"]},
        {"base": "foresight"},
        {"base": "foresee", "aliases": ["foresees", "foreseeing", "foreseeable", "foresaw", "foreseen"]},
        {"base": "signal", "aliases": ["signals", "signaling", "signalling", "signaled", "signalled"]},
        {"base": "foundation", "aliases": ["foundations", "foundational"]},
        "day 2",
        "day two",
...
THEME_SUBTHEMES: list[dict[str, object]] = [
    ...
    {"theme": "Horizon Scanning / Sense-making", "subtheme": "Future orientation",
     "terms": [
         ...
         {"base": "decade", "aliases": ["decades"]},
         {"base": "emerge", "aliases": ["emerging", "emerged", "emerges", "emergent"]},
         "tomorrow", "next wave", "next decade", "day 2", "day two",
         {"base": "foresight"},
         {"base": "foresee", "aliases": ["foresees", "foreseeing", "foreseeable", "foresaw", "foreseen"]},
         {"base": "signal", "aliases": ["signals", "signaling", "signalling", "signaled", "signalled"]},
         {"base": "wander", "aliases": ["wanders", "wandered", "wandering"]},
